...
impl<'a, 'tcx> BuilderMethods<'a, 'tcx> for Builder<'a, 'tcx> {
    ...
    fn alloca(&mut self, size: rustc_target::abi::Size, align: rustc_target::abi::Align) -> Self::Value {
        todo!()
    }

    fn dynamic_alloca(&mut self, size: Self::Value, align: rustc_target::abi::Align) -> Self::Value {
        todo!()
    }

    fn load(&mut self, ty: Self::Type, ptr: Self::Value, align: rustc_target::abi::Align) -> Self::Value {
        todo!()
    }
    ...
    fn range_metadata(&mut self, load: Self::Value, range: rustc_target::abi::WrappingRange) {
        todo!()
    }
    ...
    fn store(&mut self, val: Self::Value, ptr: Self::Value, align: rustc_target::abi::Align) -> Self::Value {
        todo!()
    }
    ...
    fn memcpy(
        &mut self,
        dst: Self::Value,
        dst_align: rustc_target::abi::Align,
        src: Self::Value,
        src_align: rustc_target::abi::Align,
        size: Self::Value,
        flags: rustc_codegen_ssa::MemFlags,
    ) {
        todo!()
    ...
    fn lifetime_start(&mut self, ptr: Self::Value, size: rustc_target::abi::Size) {
        todo!()
    }

    fn lifetime_end(&mut self, ptr: Self::Value, size: rustc_target::abi::Size) {
        todo!()
    }
